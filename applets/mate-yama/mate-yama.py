...
class YamaApplet:
    ...
    """Applet to show Yet Another Menu Applet For Mate Desktop.
    ...
    def __init__(self, applet):
        ...
        if dbus is not None:
            ...
            def name_owner_changed_cb(name, old_address, new_address):
                if name in ("org.mate.ScreenSaver", "org.mate.SessionManager"):
    ...
    def build_menu(self):
        ...
        """ Applications """
        tree = matemenu.lookup_tree("applications.menu")
        ...
        """ System """
        tree = matemenu.lookup_tree("settings.menu")
    ...
    def append_session_actions(self, menu):
        ...
        can_lock_screen = "org.mate.ScreenSaver" in dbus_services
        can_manage_session = "org.mate.SessionManager" in dbus_services
        ...
        if can_lock_screen:
            ...
            def lock_screen_cb(widget):
                ss_proxy = self.session_bus.get_object("org.mate.ScreenSaver", "/")
                ss_iface = dbus.Interface(ss_proxy, "org.mate.ScreenSaver")
        ...
        if can_manage_session:
            sm_proxy = self.session_bus.get_object("org.mate.SessionManager", "/org/mate/SessionManager")
            sm_iface = dbus.Interface(sm_proxy, "org.mate.SessionManager")
    ...
    def append_directory(self, tree, menu, index=None, item_list=None):
        for node in tree.contents:
            is_entry = isinstance(node, matemenu.Entry)
            is_separator = isinstance(node, matemenu.Separator)
            is_directory = isinstance(node, matemenu.Directory)
