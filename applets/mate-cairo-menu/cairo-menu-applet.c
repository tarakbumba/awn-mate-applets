...
cairo_menu_applet_constructed (GObject *object)
{
  ...
  GList * iter;
  GError * error = NULL;
  gchar * filename = LIBDIR"/awn/applets/mate-cairo-menu/mate-menu-builder";
  GModule      *module;
...
cairo_menu_applet_get_run_cmd (CairoMenuApplet * applet)
{
  ...
  return cairo_menu_applet_get_cmd (applet, priv->run_cmd, mate_run_cmds);
}
...
cairo_menu_applet_get_search_cmd (CairoMenuApplet * applet)
{
  ...
  return cairo_menu_applet_get_cmd (applet, priv->search_cmd, mate_search_cmds);
}
