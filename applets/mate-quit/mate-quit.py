...
#               2014 - tarakbumba <tarakbumba at tarakbumba dot com>
#
...
applet_name = _("Mate Quit/Log Out")
...
class QuitLogOutApplet:
    ...
    def __init__(self, applet):
        ...
        if "org.mate.SessionManager" in services:
            sm_proxy = session_bus.get_object("org.mate.SessionManager", "/org/mate/SessionManager")
            self.sm_if = dbus.Interface(sm_proxy, "org.mate.SessionManager")

            self.log_out_cb = self.mate_log_out
        else:
        ...
        if "org.mate.ScreenSaver" in services:
            ss_proxy = session_bus.get_object("org.mate.ScreenSaver", "/")
            self.ss_if = dbus.Interface(ss_proxy, "org.mate.ScreenSaver")

            self.lock_screen_cb = self.mate_lock_screen
        else:
    ...
    def load_settings(self):
        ...
        assert self.log_out_cb == self.mate_log_out or _("Shut Down") not in left_click_actions
...
if __name__ == "__main__":
    awnlib.init_start(QuitLogOutApplet, {"name": applet_name, "short": "mate-quit",
        ...
        "author": "tarakbumba",
        "copyright-year": "2014",
        "authors": ["Randal Barlow <im.tehk at gmail.com>", "onox <denkpadje@gmail.com>", "tarakbumba <tarakbumba at tarakbumba dot com>"]})
